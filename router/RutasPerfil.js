...
router.get('/', (req, res, next) => {
    ...
    if (manageSession(req, res, next, 'Perfil')) {
...
router.get('/editarPerfil', (req, res, next) => {
    if (manageSession(req, res, next, 'editar Perfil vista')) {
...
router.post('/actualizarPerfil', async (req, res, next) => {
    //en esta ruta haremos que el usaurio actualize sus datos en la base de datos 
    if (manageSession(req, res, next, 'actualizar datos perfil')) {
        const idUsuario = req.session.idUsuario
...
router.post('/actualizarContra', async (req, res, next) => {
