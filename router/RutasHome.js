...
router.get('/', (req, res, next) => {
    //esta linea de codigo nos permitira checar si existe la sesion si no nos regresara al login mandar el nombre como titulo
    if (manageSession(req, res, next, 'home1')) {
...
router.post('/addWater', (req, res, next) => {
    if (manageSession(req, res, next, 'home - agregar agua')) {
...
router.post('/delWater/', (req, res, next) => {
    if (manageSession(req, res, next, 'home - borrar registro agua')) {
