...
router.get('/', (req, res, next) => {
    if (manageSession(req, res, next, 'Grupos lista')) {
...
router.get('/grupo/:idGrupo', (req, res, next) => {

    if (manageSession(req, res, next, 'grupo participantes')) {
...
//crear un grupo
router.post('/crearGrupo', (req, res, next) => {
    if (manageSession(req, res, next, 'Grupos crear')) {
...
router.post('/unirseGrupo', (req, res, next) => {
    if (manageSession(req, res, next, 'unirme a grupo')) {
...
router.post('/salirGrupo', (req, res, next) => {
    console.log('click en salir de grupo')
    if (manageSession(req, res, next, 'salir de grupo')) {
        console.log('no se que esta paasndo')
