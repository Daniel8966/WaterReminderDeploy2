...
router.get('/', (req, res, next) => {
    ...
    if (manageSession(req, res, next, 'Graficaa semana')) {

        console.log('Sesion existente - grafica agua semana')
...
//GRAFICA MENSUAL
router.get('/regAguaMes', (req, res, next) => {
    if (manageSession(req, res, next, 'Grafica mensual')) {
